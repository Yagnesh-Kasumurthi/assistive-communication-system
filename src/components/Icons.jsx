...
// Beaker / test tube (for demo/lab)
export const BeakerIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M9 3h6M10 3v7.5L4 19a2 2 0 001.7 3h12.6a2 2 0 001.7-3L14 10.5V3" />
    <path d="M7 16h10" />
  </svg>
)
...
export const HandIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M18 11V6a2 2 0 00-4 0v4M14 10V4a2 2 0 00-4 0v6M10 10V6a2 2 0 00-4 0v8l-1.46-1.46a2 2 0 00-2.83 2.83L7 21h10l3-5.6a2 2 0 00-.26-2.19l-4.74-5.71" />
  </svg>
)
