  ...
  return (
    <div className="category-page page-enter">
      <div className="category-page-header">
        <div className="category-page-icon" style={{ background: 'var(--green-dim)', color: 'var(--green)' }}>
          <HeartIcon />
        </div>
        <div>
          <h1 style={{ color: 'var(--green)' }}>Health</h1>
          <p>{cat.description}</p>
        </div>
      </div>
      ...
      <div className="message-grid">
        {cat.messages.map((msg, i) => (
          <div key={msg.id} className="message-option health">
